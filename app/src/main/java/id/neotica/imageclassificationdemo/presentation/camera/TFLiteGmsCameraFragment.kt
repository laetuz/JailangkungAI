package id.neotica.imageclassificationdemo.presentation.camera
...
import id.neotica.imageclassificationdemo.data.local.ImageClassifierHelperGms
...
class TFLiteGmsCameraFragment : Fragment(R.layout.fragment_tfl_camera) {
    ...
    //tfLite
    private lateinit var imageClassifierHelper: ImageClassifierHelperGms
    ...
    private fun tfLiteCamera() {
        ...
        imageClassifierHelper = ImageClassifierHelperGms(
            context = requireContext(),
            classifierListener = object : ImageClassifierHelperGms.ClassifierListener {
